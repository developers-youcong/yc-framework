package com.yc.common.mongodb;

import com.yc.common.mongodb.vo.PageModel;
...
public class MongoService {
     ...
     * @param entiy    实体名称
     */
    public void saveOne(String collName, Class<?> entiy) {
        saveData(collName, entiy);
    }
     ...
     **/
    public Object findLikeByParam(String param, Class<?> entity, String key, String collName, String sortField, Sort.Direction direction) {
        Pattern pattern = Pattern.compile("^.*" + key + ".*$", Pattern.CASE_INSENSITIVE);
        Query query = new Query(Criteria.where(param).regex(pattern)).with(Sort.by(direction, sortField));
        return mongoTemplate.find(query, entity, collName);
    }
    ...
    public List<? extends Object> findSortByParam(Class<?> obj, String collName, Map<String, Object> map, String sortField, Sort.Direction direction) {
        ...
        return mongoTemplate.find(query, obj, collName);
    }
     ...
     * @return
     */
    public List<? extends Object> findRangeByParam(Class<?> obj, String collName, Map<String, Object> map,
     ...
     * @return
     */
    public PageModel findSortPageCondition(Class<?> clazz, String collName, Map<String, Object> map,
    ...
    public void saveData(String collName, Object entiy) {
